...
public class RandomGenerator : MonoBehaviour
{
    ...
    void GenerateRoom()
    {
        ...
        Vector2 portalWorldPositiom = new Vector2(playableWidth - 0, playableHeight - 2);
        GameObject portalInstance = Instantiate(portalPrefab, portalWorldPositiom, Quaternion.identity, transform);
